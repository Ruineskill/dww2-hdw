...
COPY . /var/www/html/ 
# Kopieer de inhoud van “.” (op de host)
...
# (RUN-lijnen worden uitgevoerd bij het BUILDEN van de IMAGE)# (de CMD-lijn wordt uitgevoerd bij het RUNNEN van een CONTAINER) 
# 
